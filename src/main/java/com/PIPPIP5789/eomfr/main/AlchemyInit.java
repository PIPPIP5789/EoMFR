...
public class AlchemyInit {
    ...
    public static void preInit(FMLInitializationEvent event) {
        ...
        //RecipeRegistry.alchemyRecipes.add(new AlchemyRecipe(new AspectList.AspectRangeList().setRange("iron", 8, 16).setRange("silver", 8, 16).setRange("dawnstone", 8, 16).setRange("lead", 8, 16).setRange("copper",  8, 16).fixMathematicalError(), Ingredient.fromItem(RegistryManager.wildfire_core), Lists.newArrayList(Ingredient.fromItem(RegistryManager.ingot_silver), Ingredient.fromItem(((ItemMetalComponent) PLATE).createComponentItemStack("dawnstone", 1).getItem()), Ingredient.fromItem(RegistryManager.ingot_silver), Ingredient.fromItem(((ItemMetalComponent) PLATE).createComponentItemStack("dawnstone", 1).getItem())), new ItemStack(RegistryManager.ember_,8)));
